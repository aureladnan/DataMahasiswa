...
public class DBHelper extends SQLiteOpenHelper {
    ...
    @Override
    public void onCreate(SQLiteDatabase db) {// TODO Auto-generated method stub db.execSQL( "create table mahasiswa " + "(id integer primary key, nim text,nama text,phone text)" );}
        public void onUpgrade (SQLiteDatabase db,int oldVersion, int newVersion)
        {// TODO Auto-generated method stub db.execSQL("DROP TABLE IF EXISTS mahasiswa");onCreate(db) }
            public boolean insertContact
            (String nim, String nama, String phone)
            {
